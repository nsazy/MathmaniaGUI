 ...
 * @author nicholassazy
 */
public class DoubleDigitSubstraction extends javax.swing.JFrame {
    ...
    /**
     * Creates new form DoubleDigitSubstraction
     */
    public DoubleDigitSubstraction() {
        initComponents();
        quiz();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Double Digit Subtraction");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoubleDigitSubstraction.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
