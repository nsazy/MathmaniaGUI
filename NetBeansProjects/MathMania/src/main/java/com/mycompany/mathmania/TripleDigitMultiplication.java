 ...
 * @author nicholassazy
 */
public class TripleDigitMultiplication extends javax.swing.JFrame {
         String userAnswer = "";
         String userInput = "";
         String corrAnswer = "";
         int index = 0;
    ...
    /**
     * Creates new form TripleDigitMultiplication
     */
    public TripleDigitMultiplication() {
        initComponents();
        quiz();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Triple Digit Multiplication");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!userAnswer.isEmpty() && userAnswer.matches("[0-9]|[1-9][0-9]|[1-9][0-9][0-9]|[1-9][0-9][0-9][0-9]|[1-9][0-9][0-9][0-9][0-9]|[1-9][0-9][0-9][0-9][0-9][0-9]")){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TripleDigitMultiplication.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
